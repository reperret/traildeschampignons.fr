...
<body>
    ...
    <main>
        <div id="rev_slider_72_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container"
            ...
            background-color:rgba(0, 122, 255, 0);">
                            <div>2nd Edition : 8 novembre 2025</div>
   ...
   -->
        ...
        <div class="bg_color_1">
            <div class="container margin_120_95">
                <div class="main_title">
                    <h1><strong>8 novembre 2025</strong> - Saint André En Vivarais</h1>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-12 text-justify">
                            ...
                            <p>À la recherche d’une aventure mêlant <b>SPORT, NATURE ET CONVIVIALITÉ</b> ? Découvrez nos
                                deux parcours emblématiques <b>LE CÈPE (35 KM)</b> et <b>LA GIROLLE (15 KM)</b> à courir
                                en duo, ainsi que <b>LA RANDO MORILLE (10 KM)</b> à faire en famille, sans chrono.</p>
                            <p>Envie d’une <b>RÉCUPÉRATION FESTIVE</b> ? Rendez-vous à <b>LA FOIRE AUX CHAMPIGNONS</b> à
                                Saint-Bonnet-le-Froid et savourez les spécialités locales !</p>
                            <p>Que vous soyez coureur aguerri ou amoureux de la nature, ce trail est fait pour vous.
                                <b>PRÊTS À ALLIER AMITIÉ, EFFORT, NATURE ET GOURMANDISE ?</b>
                            </p>
                            <p><a href="inscriptions.php">Ouverture des inscriptions prochainement !</a> </p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="box_faq">
                                ...
                                <h4>Quoi ?</h4>
                                <p>Trail en Duo, avec plusieurs parcours : <?php echo getAffichageQuoiAccueil($dbh); ?>
                                </p>
                            </div>
                        </div>
                    </div><!-- /row  -->
