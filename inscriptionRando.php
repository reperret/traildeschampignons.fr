    ...
    <main>
        ...
        <div class="container margin_60_35">
            <center>
                ...
                <p>
                    <span class="mentionPrixInscriptionRando"><?php echo $montantInscriptionRandoAdulte; ?>€ par
                        adulte<br>
                ...
                <span class="mentionPrixInscriptionRando">Vous pouvez tout à fait vous inscrire en famille sur cette
                    rando</span>
                        ...
                        <div class="box_general_3 write_review">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input type="email" id="emailRando" name="emailRando" class="form-control"
                                            value="<?php echo $_POST['emailRando']; ?>" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="telephoneRando" name="telephoneRando"
                                            class="form-control" value="<?php echo $_POST['telephoneRando']; ?>"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Adresse</label>
                                <input type="text" id="adresseRando" name="adresseRando" class="form-control"
                                    value="<?php echo $_POST['adresseRando']; ?>" required>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="cpRando" name="cpRando" class="form-control"
                                            value="<?php echo $_POST['cpRando']; ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label>Ville</label>
                                        <input type="text" id="villeRando" name="villeRando" class="form-control"
                                            value="<?php echo $_POST['villeRando']; ?>" required>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="nbRepasCarneRando" id="nbRepasCarneRando">
                                            ...
                                            <option value="<?php echo $i; ?>"
                                                <?php if ($_POST['nbRepasCarneRando'] == $i) echo " selected"; ?>>
                                                <?php echo $i; ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="nbRepasVegeRando" id="nbRepasVegeRando">
                                            <?php for ($i = 0; $i < 50; $i++) { ?>
                                            <option value="<?php echo $i; ?>"
                                                <?php if ($_POST['nbRepasVegeRando'] == $i) echo " selected"; ?>>
                                                <?php echo $i; ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <button type="button" id="addParticipant" class="btn_1 green">Ajouter un
                                            participant</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="commentaireRando" style="height: 60px;"
                                    placeholder="commentaire ou demande particulière..."><?php echo $_POST['commentaireRando']; ?></textarea>
                            </div>
