...
)
{
    ...
    $montantInscription=getMontantTotalInscription("course", $_POST, $dbh);
...
{
    $manqueParametres="Veuillez remplir tous les champs ! " ;
}
...
<head>
    ...
    <script>
        function changerLibelle() {
            // Récupérer l'élément sélectionné
            var select = document.getElementById("selectIdCourse");
            var option = select.options[select.selectedIndex];

            // Récupérer le montant d'inscription depuis l'attribut data-montant
            var montant = option.getAttribute("data-montant");

            // Mettre à jour le texte du libellé
            document.getElementById("monLibelle").innerHTML = "Le prix de l'inscription est de <span class=\"montantInscriptionPageInscription\">" + montant + "</span>€";
        ...
        function redirectUser() {
            var select = document.getElementById("selectIdCourse"); // Obtention de l'élément select
            var value = select.options[select.selectedIndex].value; // Obtention de la valeur sélectionnée

            if (value == "3") { // Vérifier si une valeur est sélectionnée
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="idCourse" id="selectIdCourse" onchange="changerLibelle()">
                                            <?php
                                    ...
                                    foreach($courses as $course) 
                                    {
                                        ...
                                        {
                                            if($course['idCourse']==$_GET['idCourse']) $firstMontantInscriptionListe=$course['montantInscriptionCourse'];
                                        }
                                        else
                                        {
                                             if($first) $firstMontantInscriptionListe=$course['montantInscriptionCourse'];
                                             $first=false;
                                        }                                       
                                       
                                        
                                        // Ajout de l'attribut data-montant pour stocker le montant d'inscription
                                        ?><option value="<?php echo $course['idCourse']; ?>" data-montant="<?php echo $course['montantInscriptionCourse']; ?>" <?php if($course['idCourse']==$_GET['idCourse']) echo " selected";?>>
                                                <?php echo $course['libelleCourse']." ".$course['distanceCourse']."km"; ?>
                                            </option><?php
                                    }
                                    ?>
                                        </select>
                                    ...
                                    <label id="monLibelle">Le prix de l'inscription est de <span class="montantInscriptionPageInscription"><?php echo $firstMontantInscriptionListe;?>€</span></label>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="cadeauCoureur1" class="form-control">
                                            ...
                                            <option value="T" <?php if($_POST['cadeauCoureur1']=="T") echo " selected";?>>Textile</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <span class="mentionInscriptionRefus">Certifcat médical de non-contre-indication à la pratique de l'athlétisme en compétition ou
                                    ...
                                    <div class="form-group">
                                        <div class="checkboxes add_bottom_30 add_top_15">
                                            <label class="container_check">
                                                ...
                                                <input name="refusResultatsCoureur2" type="checkbox">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="cadeauCoureur2" class="form-control">
                                            ...
                                            <option value="T" <?php if($_POST['cadeauCoureur2']=="T") echo " selected";?>>Textile</option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio-container">
                                            <input type="radio" name="repasCoureur2" id="repasCoureur1" class="radio-input" value="Non" <?php if(isset($_POST['repasCoureur2']) && $_POST['repasCoureur2']=="Non") echo "checked"; ?> checked>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group">
                                        <label>Allergies/Préférences alimentaires</label>
                            ...
                            <div class="form-group">
                                <div class="checkboxes add_bottom_30 add_top_15">
                                    <label class="container_check">
                                        ...
                                        Par la présente inscription, Les 2 coureurs reconnaissent avoir pris connaissance du <a href="#0">réglement</a> de la compétition, et déclarent l'accepter sans aucune restriction. Ils s'engagent à être en possession du matérieI de sécurité requis dans le règlement de l'épreuve durant la durée de celle-ci


                                        <input name="accepteReglementEquipe" id="accepteReglementEquipe" type="checkbox">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            formulaire.addEventListener("submit", function(e) {
                // Sélectionner la case à cocher par son ID
                var caseACocher = document.getElementById("accepteReglementEquipe");
