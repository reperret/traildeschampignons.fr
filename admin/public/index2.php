...
$nbJoueurs=-1;
if(isset($_POST['nbJoueurs']) &&  $_POST['nbJoueurs']!=-1) $nbJoueurs=$_POST['nbJoueurs'];




$listingExemplaires=getExemplaire2($idLudotheque,NULL,NULL,$age,$litteratie,$statut,$type,$difficulte,$nbJoueurs,$dbh);
...
<select name="nbJoueurs" id="select">
    <option value="-1">Nombre joueurs</option>
         <?php
    //$minMaxJoueursJeu=getMinMaxJoueursJeu($dbh);
    for($i=1;$i<=25;$i++)
    {
        ?><option value="<?php echo $i;?>" <?php if($nbJoueurs==$i) echo " selected"; ?>><?php echo $i;?></option><?php
    }
    ?>
</select>
